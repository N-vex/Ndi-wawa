          ...
          <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-8">
            ...
            <div className="md:w-1/2">
              <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                Over the past year, Wawa Cooperation Club has made significant
                strides in improving the lives of orphans and supporting local
                communities. We have successfully organized over 10 community
                events, raising more than $50,000 for healthcare and educational
                initiatives. Our partnerships with local organizations have
                enabled us to share resources effectively, ensuring that our
                efforts lead to sustainable change. Through our collective
                dedication, we have empowered numerous orphans to pursue their
                dreams and contribute positively to society.
              </p>
            </div>
          </div>
        </div>
