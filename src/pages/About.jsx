        ...
        ></video> */}
            ...
            <div className="md:w-1/2 mt-8 md:mt-0">
              ...
              <p className="mb-8 text-lg font-normal text-gray-700 dark:text-gray-300">
                Our partnerships with local organizations have enabled us to
                share resources effectively, ensuring that our efforts lead to
                sustainable change. Through our collective dedication, we have
                empowered numerous orphans to pursue their dreams and contribute
